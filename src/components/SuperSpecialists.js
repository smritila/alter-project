...
function SuperSpeciaLists() {
  const destinations = [
    ...
    { image: DestinationImage5, title: "India" },
    { image: DestinationImage4, title: "Greece" },
    { image: DestinationImage3, title: "America" },
    { image: DestinationImage5, title: "Italy" },
    { image: DestinationImage4, title: "Russia" },
    { image: DestinationImage3, title: "Japan" },
    { image: DestinationImage5, title: "Switzerland" },
  ];
